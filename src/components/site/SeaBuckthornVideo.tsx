...
const SCENES: Scene[] = [
  {
    ...
    description: "Sourced from wild sea buckthorn berries growing above 12,000 feet, where intense sunlight and extreme cold concentrate active nutrients.",
    image: berriesImg,
  ...
  },
  {
    ...
    description: "Our proprietary cold-press process extracts pure oil drop-by-drop without heat or solvents, retaining 190+ highly bioactive compounds.",
    image: oilImg,
  ...
  },
  {
    ...
    description: "Packed with rare Omega-7, essential fatty acids (3, 6, 9), and powerful antioxidants in a plant-based vegan capsule for cellular renewal.",
    image: capsulesImg,
...
const HOTSPOTS: Hotspot[] = [
  {
    ...
    y: "35%",
    title: "Rare Omega-7",
    description: "Provides ultra-rich palmitoleic acid, a rare nutrient vital for deeply hydrating mucosal membranes and promoting radiant skin elasticity.",
  ...
  },
  {
    ...
    description: "Supercritical CO2 extracted seed and berry oil blend. Completely unrefined, gluten-free, and contains no synthetic fillers.",
  ...
  },
  {
    ...
    y: "55%",
    title: "Vegan Shell",
    description: "Hypromellose-based, fast-dissolving capsule shell. Optimizes nutrient absorption in the stomach and protects delicate oils from oxidation.",
  ...
  },
  {
    ...
    description: "A natural powerhouse combining vitamins A, B1, B2, B6, C, and E, with high levels of beta-carotene and essential fatty acids 3, 6, and 9.",
...
export function SeaBuckthornVideo() {
  ...
  return (
    <div className={`relative transition-all duration-700 ${isCinematic ? "bg-slate-950 py-16 text-white" : "bg-gradient-to-b from-orange-50/50 via-white to-white py-16 md:py-24"}`}>
      ...
      <div className={`container mx-auto px-6 relative transition-all duration-500 ${isCinematic ? "z-20 max-w-6xl" : "max-w-7xl"}`}>
        ...
        <div className="text-center mb-12 relative">
          ...
          <h2 className={`font-display text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight ${isCinematic ? "text-white" : "text-slate-900"}`}>
            Sourcing <span className="text-orange-600 italic font-light">Natural Radiance</span>
          </h2>
          <p className={`mt-4 text-lg max-w-2xl mx-auto font-light ${isCinematic ? "text-slate-300" : "text-slate-600"}`}>
            Journey into the pristine high altitudes to witness how our premium Sea Buckthorn Capsules are harvested, extracted, and crafted to encapsulate life's vitality.
          </p>
        </div>
                          ...
                          {isActive && (
                            ...
                            >
                              <div className="flex justify-between items-start mb-2">
                                ...
                                <button onClick={() => setActiveHotspot(null)} className="text-white/40 hover:text-white transition">
                                  <X className="h-3.5 w-3.5" />
                                </button>
                              </div>
                              <h4 className="font-bold text-sm mb-1">{hotspot.title}</h4>
                              <p className="text-xs text-white/70 leading-relaxed font-light">{hotspot.description}</p>
                            </motion.div>
                          )}
                        </AnimatePresence>
                      </div>
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-6 z-30 transition-all duration-300">
              ...
              <div className="flex items-center justify-between text-white select-none">
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    {isCinematic ? <Minimize2 className="h-5 w-5" /> : <Maximize2 className="h-5 w-5" />}
                  </button>
                </div>
              </div>
