    ...
    <div className="bg-white min-h-screen selection:bg-primary/20">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl space-y-8">
            ...
            <h1
              className="font-display text-4xl sm:text-6xl md:text-8xl font-medium text-white leading-tight animate-fade-in-up"
            ...
            <p
              className="text-xl text-white/70 max-w-xl leading-relaxed animate-fade-in-up"
              style={{ animationDelay: "0.4s" }}
            >
              PaskinCare stands as a beacon of excellence in pharmaceutical trading, bridging the
              gap between innovative science and worldwide accessibility.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-12">
            <div className="space-y-4">
              ...
              <h2 className="font-display text-4xl md:text-5xl font-medium text-foreground leading-tight">
                To become the most <span className="text-primary italic">trusted choice</span> in
                global pharmaceutical logistics.
              </h2>
            </div>
            <p className="text-xl text-muted-foreground leading-relaxed font-light">
              Welcome to PaskinCare, a leading pharmaceutical trading company that specializes in
              connecting the world's healthcare providers with top-quality medicines and innovative
              healthcare solutions. With an unwavering commitment to excellence, we strive to be
              your trusted partner in the global pharmaceutical trade.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
                <p>
                  At Paskin, we understand the critical role that pharmaceuticals play in improving
                  and saving lives. That's why we diligently source and supply a comprehensive range
                  of high-quality medicines, ensuring access to safe and effective treatments for a
                  wide array of medical conditions.
                </p>
                <p>
                  Our dedicated team of experts works tirelessly to maintain strong relationships
                  with trusted manufacturers, ensuring that we offer an extensive portfolio of
                  pharmaceutical products that meet the highest quality standards.
                </p>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-20">
            <div className="lg:w-1/3 space-y-6">
              <h3 className="font-display text-5xl font-medium leading-tight">
                Beyond <br /> Distribution
              </h3>
              <p className="text-muted-foreground leading-relaxed">
                We provide comprehensive support throughout the entire process, from regulatory
                compliance to efficient logistics, ensuring a seamless experience.
              </p>
            </div>
            <div className="lg:w-2/3 grid sm:grid-cols-2 gap-12">
              <div className="p-10 rounded-3xl bg-slate-50 border border-border/50 hover-lift transition-all">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Facilitating import/export with a vast network, ensuring timely delivery to
              ...
              <div className="p-10 rounded-3xl bg-slate-50 border border-border/50 hover-lift transition-all">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  From generic drugs to specialized medications, we offer a diverse range that meets
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-background/50 text-sm">
                  Our guarantee on quality and authenticity.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-background/50 text-sm">
                  Prioritizing safety and hygiene in every shipment.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center text-center space-y-6">
      ...
      <section className="py-32 text-center bg-white">
        <div className="container mx-auto px-6 max-w-3xl space-y-10">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed font-light">
            Thank you for considering Paskin as your pharmaceutical partner. Let's collaborate to
            enhance healthcare outcomes around the globe.
          </p>
