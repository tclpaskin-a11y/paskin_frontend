...
export default function AdminOrders() {
  ...
  const mapToUIOrder = (order: any) => {
    const isCompleted = order.status === "completed" || order.status === "approved" || order.status === "delivered";
    ...
    const customerName = typeof order.userId === "object" && order.userId ? order.userId.name : (order.userId || "Guest");
    ...
    const image = order.items?.[0]?.productId?.images?.[0] || "https://images.unsplash.com/photo-1611073103901-09605d8f6cc9?auto=format&fit=crop&q=80&w=300";
                    ...
                    <div className="flex flex-col xl:flex-row gap-8">
                      ...
                      <div className="flex-1 flex gap-6">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div className={`h-1.5 w-1.5 rounded-full ${order.isCompleted ? 'bg-emerald-500' : order.isPending ? 'bg-amber-500' : 'bg-rose-500'}`} />
                          </div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 xl:border-x border-slate-50 xl:px-8">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm font-bold text-slate-800 capitalize">{order.statusLabel}</p>
                        </div>
                      </div>
